...
Nova.booting(function (Vue, router) {
    Vue.component('index-countable', __webpack_require__(3));
    Vue.component('detail-countable', __webpack_require__(6));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins__ = __webpack_require__(9);
//
//
//
//
...
var render = function() {
  ...
  return _vm.emptyField
    ? _c("span", [_vm._v("\n\t—\n")])
    : _c("span", [
        _c("strong", { staticClass: "font-bold" }, [
          _vm._v(_vm._s(_vm.field.value) + " " + _vm._s(_vm.fieldLabel))
        ])
      ])
}
var staticRenderFns = []
